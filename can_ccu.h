...
#define CCU_DRIVE_CURRENT3_SUBINDEX				0
...
#define CCU_ASSEMBLY_INDEX						0x2200
#define CCU_ASSEMBLY_ARRAY_SIZE					2
#define CCU_ASSEMBLY_TELESCOPE_INDEX			1
#define CCU_ASSEMBLY_CABROT_INDEX				2
#define CCU_ASSEMBLY_TYPE						CANOPEN_ARRAY8
#define CCU_ASSEMBLY_PERMISSIONS				CANOPEN_RW

#define CCU_ASSEMBLY_WRITE_INDEX				0x2201
