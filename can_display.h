...
#define DSPL_BRIGHTNESS_REQ_INDEX		0x2101
#define DSPL_BRIGHTNESS_REQ_SUBINDEX	0
#define DSPL_BRIGHTNESS_REQ_TYPE		CANOPEN_SIGNED8
#define DSPL_BRIGHTNESS_REQ_PERMISSIONS	CANOPEN_WO
