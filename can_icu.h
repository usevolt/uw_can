...
#define ICU_FORCEPUMP_REQ_INDEX					0x2101
#define ICU_FORCEPUMP_REQ_SUBINDEX				1
#define ICU_FORCEPUMP_REQ_TYPE					CANOPEN_SIGNED16
#define ICU_FORCEPUMP_REQ_PERMISSIONS			CANOPEN_RO
