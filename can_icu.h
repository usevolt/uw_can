...
#define ICU_WIDTH_UM_TYPE						CANOPEN_UNSIGNED32
#define ICU_WIDTH_UM_PERMISSIONS				CANOPEN_RO

#define ICU_WIDTH_CALIB_REQ_INDEX				0x2306
#define ICU_WIDTH_CALIB_REQ_ARRAY_SIZE			2
#define ICU_WIDTH_CALIB_REQ_TYPE				CANOPEN_UNSIGNED8
#define ICU_WIDTH_CALIB_REQ_PERMISSIONS			CANOPEN_WO



#define ICU_VOL_DM3_INDEX						0x230A
