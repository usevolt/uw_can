...
#define CSB_WIPER_MANUAL_INDEX				0x2155
#define CSB_WIPER_MANUAL_SUBINDEX			0
#define CSB_WIPER_MANUAL_TYPE				CANOPEN_UNSIGNED8
#define CSB_WIPER_MANUAL_PERMISSIONS		CANOPEN_RW
...
#define CSB_FSB_INDEX_OFFSET				0x1000
